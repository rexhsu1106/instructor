...
-->
	...
	<div style="max-width: 100%" class="row align-center">
		...
		-->
			<textarea name="lessonInfo" disabled rows="2"></textarea>
			</label>
		</div>
 	</div>
	...
	<div style="max-width: 100%" class="row align-center">
 	...
 	<div style="max-width: 100%" class="row align-center">
		<div class="column small-12 large-10">
			<label><h6>學生備註</h6>
			<textarea name="studentComment" disabled rows="3"></textarea>
			</label>
		</div>
	</div>
	...
	<div style="max-width: 100%" class="row align-center">
		<div class="column small-12 large-10">
			<label><h6>教練建議</h6>
			<textarea name="comment" disabled rows="3"></textarea>
			</label>
		</div>
	</div>
	...
	function setSelfRatingRecords(records)
	{
		...
		if(records && records.length > 0)
		{
			...
			for(key in records)
			{
				...
				$('#selfRatingInfo').text("學生自我評量建立時間 "+date[0]).show().css("color", "green");
				if(gType == 'sb')
		...
		else
		{
			...
			$('#selfRatingInfo').text("學生尚未建立自我評量").show().css("color", "blue");
